...
def ExecutePrompt():
    ...
    smBot = SimpleMode()
    GameSelect()
    smBot.smActive(mon_values= monsval_data, m_values= misval_data, i_values= infval_data, battle_master_bop_adjust_x= bop_adjust_valx, battle_master_bop_adjust_y= bop_adjust_valy, defense_line=trk_get, confidence=confidence_get , game_Pointx=gamePointx, game_Pointy=gamePointy)
